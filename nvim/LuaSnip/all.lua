...
-- ISSUE: does not work
--
-- -- copied from: https://github.com/L3MON4D3/LuaSnip/wiki/Cool-Snippets#all---todo-commentsnvim-snippets
...
{ -- manual snippets
	...
	-- 		trig = "testAutoChange",
	-- 		dscr = "An autotriggering snippet that expands 'testAutoChange'",
	-- 		regTrig = false,
	-- 		priority = 100,
	-- 		snippetType = "autosnippet",
	-- 	},
	-- 	{              -- Table 2: snippet nodes (don't worry about this for now---we'll cover nodes shortly)
	-- 		t("auto snippet works in all buffers!"), -- A single text node
	-- 	}
	-- ),
